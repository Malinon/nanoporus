...
from flow_filtrations.general_flow_filtration import gen_flow_filtration, gen_avg_direction_flow_filtration
...
RADIUS = 1
HEIGHT = 2
OUTPUT_NAME_TMPL = "filtrations/avg_flow_r" + str(RADIUS) + "_h" +str(HEIGHT) + "/rand/filtration_"
...
def get_filtration(i):
    ...
    filtration =  gen_flow_filtration(mat_data, grapher, gen_avg_direction_flow_filtration)
